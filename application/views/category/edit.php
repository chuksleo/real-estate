...
?>
        ...
        <?= form_open_multipart(base_url() . 'admin/categoryedit/'.$category->catId) ?>
          ...
          <div class="form-group col-md-6">
            <label for="state">Category Status</label>
                <select name="status" class="form-control" required>
                                                    ...
                                                    <option value="On" <?php if($category->status == 'On'){ echo "Selected";} ?> >Active</option>
                                                    <option value="Off" <?php if($category->status == 'Off'){ echo "Selected";} ?> >Disabled</option>
                   </select>                                 
