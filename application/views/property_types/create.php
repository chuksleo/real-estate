...
?>
        <div class="content">
                <div class="container">
                    <div class="page-title">
                        <h3><?php echo $action ?> Property Types</h3>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                        <div class="card">
        ...
        <?= form_open_multipart(base_url() . 'admin/propertyTypeAdd/') ?>
    ...
    <div class="form-row">
        ...
        <?= form_fieldset_close() ?>
         <div class="form-group col-md-6">
        <?= form_submit('submit', 'Save Property Type', array("class" => "btn btn-primary")) ?>
